...
python train.py --backbone Resnet50 --n_filters 5 --bridge Resnet50 --decoder SimpleDecoder --n_block 1 --train_size 352 --batch_size 16 --augmentation
...
python eval_model.py --backbone Resnet50 --n_filters 5 --bridge Resnet50 --decoder SimpleDecoder --n_block 1 --train_size 352 --batch_size 16 --augmentation 
